...
def main():
	...
	if data['lat'] < 10:
        ...
        if data['city'] == "Singapore":
            data['temperature'] = float(data['temperature']) + round(random.uniform(40,60), 1)
            data['humidity'] = float(data['humidity']) + round(random.uniform(20, 40), 1)
